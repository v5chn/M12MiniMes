...
namespace M12MiniMes.UI
{
    ...
    /// 设备表    
    /// </summary>	
    public partial class FrmMaster设备参数表 : BaseDock
    {
        public FrmMaster设备参数表()
        {
            InitializeComponent();
        ...
        {
            FrmEdit设备参数表 dlg = new FrmEdit设备参数表();
        ...
        {
        	//entity
            this.winGridView2.DisplayColumns = "参数id,参数名称,参数值,设备id,设备名称";
            this.winGridView2.ColumnNameAlias = BLLFactory<设备参数表>.Instance.GetColumnNameAlias();//字段列显示名称转义

            #region 添加别名解析

            //this.winGridView2.AddColumnAlias("参数id", "参数ID");
            //this.winGridView2.AddColumnAlias("参数名称", "参数名称");
            //this.winGridView2.AddColumnAlias("参数值", "参数值");
            ...
            string where = string.Format("设备ID ='{0}'", headerID);
	            List<设备参数表Info> list = BLLFactory<设备参数表>.Instance.Find(where);
            this.winGridView2.DataSource = list;//new WHC.Pager.WinControl.SortableBindingList<设备参数表Info>(list);
                this.winGridView2.PrintTitle = "设备参数表报表";
        ...
        private void CreateSummary()
        {
            ...
            if (gridView1 != null && gridView1.Columns.Count > 0)
            {
                ...
                DevExpress.XtraGrid.Columns.GridColumn 参数idColumn = gridView1.Columns["参数id"];
                参数idColumn.Summary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
                    new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "参数id", "参数ID：{0}")});
                DevExpress.XtraGrid.Columns.GridColumn 参数名称Column = gridView1.Columns["参数名称"];
                参数名称Column.Summary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
                    new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "参数名称", "参数名称：{0}")});
                DevExpress.XtraGrid.Columns.GridColumn 参数值Column = gridView1.Columns["参数值"];
                参数值Column.Summary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
                    new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "参数值", "参数值：{0}")});
        ...
        private void gridView2_DataSourceChanged(object sender, EventArgs e)
        {
            if (this.winGridView2.gridView1.Columns.Count > 0 && this.winGridView2.gridView1.RowCount > 0)
            {
                ...
                if (gridView1 != null)
                {
                //gridView1.SetGridColumWidth("参数id", 120);
                //gridView1.SetGridColumWidth("参数名称", 120);
                //gridView1.SetGridColumWidth("参数值", 120);
                //gridView1.SetGridColumWidth("设备id", 120);
                //gridView1.SetGridColumWidth("设备名称", 120);
                gridView1.SetGridColumWidth("参数id", 150);
                gridView1.SetGridColumWidth("参数名称", 150);
                gridView1.SetGridColumWidth("参数值", 150);
